...
def interface():
    ...
    while True:
        command = input("Введите команду или \"open\" для списка команд: ").lower()
        if command == 'open':
            print("Список команд:")
            print("\t\"create\" – создать новый файл")
            print("\t\"random\" – сгенерировать случайный список")
